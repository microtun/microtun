//! Device-configuration storage and setup helpers shared only by the embedded examples.
//!
//! This module intentionally stays example-local. Generic network behavior
