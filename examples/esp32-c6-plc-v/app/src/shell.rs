//! Telnet shell and ESP32-C6-specific diagnostics.
//!
//! Command/session flow and setup-vs-operational state live in `examples/common`; this module
...
use crate::{
    DEVICE_MODEL, ESP_APP_DESC, IdentifyLedPin, network::wifi_link_snapshot, storage::Storage,
};

const TELNET_BANNER: &str = "microtun ESP32-C6-PLC-V\r\ntype 'help' for commands";
const SETUP_TELNET_BANNER: &str = "microtun ESP32-C6-PLC-V setup mode\r\ntype 'help' for commands";
...
#[derive(Debug, Parser)]
#[command(name = "microtun", about = "microtun ESP32-C6-PLC-V shell")]
enum Command {
