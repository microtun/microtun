...
# ESP-IDF eFuse anti-rollback is intentionally not enabled. On ESP32-C6,
# CONFIG_BOOTLOADER_APP_ANTI_ROLLBACK uses a 16-bit irreversible
# secure-version floor (at most 16 increments), not firmware x.y.z SemVer.
# The application enforces authenticated MCUboot SemVer; see ../README.md.
