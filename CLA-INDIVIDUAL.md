# microtun Individual Contributor License Agreement

> **microtun ICLA Version 1.0 — 10 August 2026.** Identify this version in any
> signing record. Changes are published as a new numbered version; an executed
> version is never edited in place. Attribution and adaptations are in the
> [Appendix](#appendix-attribution-and-adaptations).

Thank you for your interest in contributing to microtun, maintained by Damian
Peckett ("We" or "Us").

This contributor agreement ("Agreement") documents the rights granted by
contributors to Us. To make this document effective, please sign it and send it
to Us by electronic submission, following the instructions in
[`CONTRIBUTING.md`](CONTRIBUTING.md#signing-the-cla). This is a legally binding
document, so please read it carefully before agreeing to it.
...
[`CONTRIBUTING.md`](CONTRIBUTING.md#third-party-material).
...
"Material" means the microtun work of authorship which is made available by Us
to third parties. After You Submit the Contribution, it may be included in the
Material.
...
Where a license We are using for the Material on the Submission Date itself
provides that the Material becomes available under a further license after a
stated date, as the Business Source License 1.1 does through its Change Date
and Change License parameters, that further license forms part of the license
or licenses We are using on the Submission Date, and Our commitment in this
Section 2.3 extends to it on the terms so stated.
...
[`CONTRIBUTING.md`](CONTRIBUTING.md#third-party-material), if You do not own the
...
the Federal Republic of Germany excluding its conflicts of law provisions.
...
Signature / electronic acceptance: ______________________________

Name: __________________________________________________________

Address: _______________________________________________________

GitHub username (optional): ____________________________________
...
Title: microtun maintainer and licensor

Address: _______________________________________________________

Contact: owner@microtun.dev

Date: __________________________________________________________

---

## Appendix: Attribution and adaptations

Adapted from the **Harmony Individual Contributor License Agreement
(HA-CLA-I), Version 1.0, July 4, 2011** (the `ANY` outbound variant), published
by Project Harmony under the
[Creative Commons Attribution 3.0 Unported License](https://creativecommons.org/licenses/by/3.0/).
Source: <https://www.harmonyagreements.org/docs/ha-cla-i-v1.pdf>

Adaptations: named microtun and Damian Peckett as the project and licensor;
selected outbound license **Option Five** and removed Options One to Four;
omitted the optional Media license and the now-unused "Media" definition;
removed the optional "or Your Affiliates" wording from Section 2.2; replaced
the placeholder submission and third-party-material instructions with links to
[`CONTRIBUTING.md`](CONTRIBUTING.md); set the governing law in Section 6.1 to
Germany; added the second paragraph of Section 2.3 on change licenses; and
reformatted as Markdown with microtun execution and contact fields. The
operative Harmony text is otherwise unchanged.

No endorsement by Project Harmony is implied.