//! STM32H753ZI firmware slot handling.
//!
//! The TELNET/YMODEM/MCUboot transport lives in
//! `microtun_firmware_common::firmware`; what remains here is the Embassy Boot
...
const FIRMWARE_COMPONENT_ID: &str = "stm32h753zi";
...
pub(crate) fn firmware_update_error_text(error: &FirmwareUpdateError) -> &'static str {
    match error {
        ...
        FirmwareUpdateError::Flash(Stm32SinkError::InvalidVectorTable) => {
            "MCUboot payload is not an STM32H753ZI application image"
        }
