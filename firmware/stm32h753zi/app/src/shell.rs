//! Telnet shell and STM32H753ZI diagnostics.
//!
...
use crate::{
    FIRMWARE_VERSION,
    board::{DEVICE_MODEL, IdentifyLedPin, phy_link_snapshot},
    reset,
    storage::Storage,
    temp_sensor::TemperatureSensor,
};

const TELNET_BANNER: &str = "microtun STM32H753ZI\r\ntype 'help' for commands";
const SETUP_TELNET_BANNER: &str = "microtun STM32H753ZI setup mode\r\ntype 'help' for commands";
...
#[derive(Debug, Parser)]
#[command(name = "microtun", about = "microtun STM32H753ZI shell")]
enum Command {
