...
const TELNET_BANNER: &str = "microtun ESP32-C6\r\ntype 'help' for commands";
const SETUP_TELNET_BANNER: &str = "microtun ESP32-C6 setup mode\r\ntype 'help' for commands";
...
#[derive(Debug, Parser)]
#[command(name = "microtun", about = "microtun ESP32-C6 shell")]
enum Command {
