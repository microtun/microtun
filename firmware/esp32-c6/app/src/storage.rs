//! ESP32-C6 storage adapter for the shared firmware workflow.
//!
//! `firmware/common` owns synchronization and the configuration write/verify lifecycle. This
